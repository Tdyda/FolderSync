...
public class DeletionEngineTests
{
    ...
    private static DirectorySnapshot Snap(string root,
    ...
    public async Task RemoveFiles_Deletes_Existing_Files_Including_ReadOnly()
    {
        ...
        var replica = Snap(root, new[] { "" }, new Dictionary<string, FileMetadata>());
    ...
    public async Task RemoveDirectories_Skips_When_NotEmpty()
    {
        ...
        var replica = Snap(root, new[] { "", "keep", "keep/child" }, new Dictionary<string, FileMetadata>());
